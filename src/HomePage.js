...
const HomePage = () => {
  ...
  return (
    <>
      <header className="md:m-16 md:p-3 m-1 p-1" >
        ...
        <div className="grid md:grid-cols-2 md:items-center max-[1020px]:block md:m-16 md:p-3 m-1 p-1 ">
          ...
          <div className="">
            <div className="font-Raleway md:mx-6 md:px-6 max-[1020px]:text-center max-[1020px]:items-center ">
              <div className="text-[62px] font-light" id="/home">Be a <b className="m-0 p-0 font-semibold">Plant Parent </b>
                today</div>
        ...
        <div className="grid md:grid-cols-3 text-center text-3xl font-Raleway font-bold text-[#065f46] m-4 p-3  items-center align-middle">
          ...
          <div className='max-[1020px]:block '>
            <img className="md:pl-24 max-[720px]:ml-32 md:m-6 max-[360px]:-pl-3 pl-1 m-3" src={require("./New folder (2)/logo/Counter_1.png")} alt="" />
          ...
          <div>
            <img className="md:pl-24 max-[720px]:ml-32 md:m-6 pl-1 m-3" src={require("./New folder (2)/logo/Counter_2.png")} alt="" />
            <div className="text-orange-300 text-[80px] font-normal">{tim}</div> <div className="whitespace-pre-wrap"> </div>
            Happy<div className="whitespace-pre-wrap">customers
            </div>
          </div>
          <div>
            <img className="md:pl-24 max-[720px]:ml-32 md:m-6 pl-1 m-2" src={require("./New folder (2)/logo/Counter_3.png")} alt="" />
            <div className="text-orange-300 text-[80px] font-normal">{tim} </div> <div className="whitespace-pre-wrap"> </div>
