      ...
      <div className="font-Raleway m-2  md:m-6  py-16 max-[720px]:text-center md:px-10 p-5 ">
        ...
        <div className="grid min-[960px]:grid-cols-3 min-[760px]:grid-cols-2 justify-items-center sm:m-16 sm:p-10">
          <div className=" items-center">
            ...
            <div className=" block text-center m-5 text-[14px] text-[#5a5757]">We're trying to teach you a<div className="whitespace-nowrap"> </div>technique here and how to use</div>
          </div>
          <div className=" items-center">
            ...
            <div className=" block text-center m-4 text-[14px] text-[#5a5757]">Just make a decision and let it <div className="whitespace-nowrap"> </div>go.</div>
          </div>
          <div className=" items-center">
            ...
            <div className=" block text-center m-4 text-[14px] text-[#5a5757]">We'll throw some old gray<div className="whitespace-nowrap"> </div>clouds in here just sneaking</div>
          </div>
          <div className=" items-center">
            ...
            <div className=" block text-center ">CFO</div>
            <div className=" block text-center m-4 text-[14px]  text-[#5a5757]">Everything's not great in life, but<div className="whitespace-nowrap"> </div> we can still find beauty in it.</div>
            ...
            <div className=" block text-center m-4 text-[14px] text-[#5a5757]">That is when you can experience <div className="whitespace-nowrap"> </div>true joy, when you have no fear.</div>
          </div>  <div className=" items-center">
            ...
            <div className=" block text-center m-4 text-[14px] text-[#5a5757]"><div className="whitespace-nowrap"> </div>Let's make a nice big leafy tree.</div>
          </div>
        </div>
      </div>
    </>
